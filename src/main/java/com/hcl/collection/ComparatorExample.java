...
public class ComparatorExample {
    ...
    Collections.sort(list, (o1,o2)-> o1.empName.compareTo(o2.empName)); // Lamda (o1,o2)->o1.empName.compareTo(o2.empName)
    																	//      parameters    expression thats runs and returns
    System.out.println("Sort by empAge new:");
    list.forEach(System.out::println);
